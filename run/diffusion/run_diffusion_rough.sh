...
python -m run.diffusion.run_diffusion_rough --model "diffusion" --target "difference" --scheduler "linear" --order 4 --nmaps 1 --batch_size 16
#python -m run.diffusion.run_diffusion_rough --model "diffusion" --target "HR" --scheduler "linear" --order 4 --nmaps 10 --batch_size 24