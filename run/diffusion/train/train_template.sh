...
python -m run.diffusion.run_diffusion --n_maps _n_maps --nside _nside --order _order --batch_size _batch --difference _difference --conditioning _cond --norm_type _norm --act_type _act --use_attn _use_attn --mask _mask --scheduler _scheduler --timesteps _timesteps --log_name _log_name