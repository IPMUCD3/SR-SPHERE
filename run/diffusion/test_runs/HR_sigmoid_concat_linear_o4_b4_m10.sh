#!/bin/bash
#SBATCH --job-name=hscl_o4_b4_m10
#SBATCH --account=akira.tokiwa
#SBATCH --output=/gpfs02/work/akira.tokiwa/gpgpu/Github/SR-SPHERE/log/testruns/hscl_o4_b4_m10.out  
#SBATCH --error=/gpfs02/work/akira.tokiwa/gpgpu/Github/SR-SPHERE/log/testruns/hscl_o4_b4_m10.err  
